...
export default function GitHubCalendarClient({ username = 'brignano', initialYear = 'last', colorScheme = 'light', title, description, buttonSize = 'small' }: Props) {
        ...
        {Array.from({ length: 5 }, (_, i) => new Date().getFullYear() - i).map((y) => (
          <button
            ...
            className={
              ...
              " " +
              (buttonSize === 'large' ? "px-4 py-2 md:px-6 md:py-4" : "px-4 py-2") +
